...
volatile uint16 home_pwm[SERVO_NUM + 1] = { 0, HOME_PWM_S1, HOME_PWM_S2, HOME_PWM_S3, HOME_PWM_S4 };
...
volatile uint32 ccpd0, ccpd1, odis0, odis1;
volatile uint32 cps0, cps1, clkdiv0, clkdiv1;
...
static void cap_regs(void)
{
    ...
    ccpd0 = TIMG0->COMMONREGS.CCPD;  ccpd1 = TIMA1->COMMONREGS.CCPD;
    odis0 = TIMG0->COMMONREGS.ODIS;  odis1 = TIMA1->COMMONREGS.ODIS;
    cps0  = TIMG0->COMMONREGS.CPS;   cps1  = TIMA1->COMMONREGS.CPS;
    clkdiv0 = TIMG0->CLKDIV;         clkdiv1 = TIMA1->CLKDIV;
}
